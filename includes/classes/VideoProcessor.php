...
class VideoProcessor{
    ...
    private function processData($videoData, $filePath)
    {
            ...
            // file size check
            if (!$this->isValidize($videoData)){
                echo "File too large cannot be larger than ". $this->sizeLimit . " bytes";
                return false ;
    ...
    private function isValidize($data)
    {
    ...
    {
        $sql="INSERT INTO videos(title,uploadedBy,description,privacy,category,filePath) VALUES
    ...
    public function generateThumbnails($filePath)
    {
            ...
            for($num=1; $num<=$numThumbnails; $num++)
            {
                ...
                if(!$success)
                {
                    echo "Error insering thumbnails\n";
                    return false;
                }
